...
run("testLaunchArgumentsRejectLineBreaks", config.testLaunchArgumentsRejectLineBreaks)
...
let coreUtilities = SetupCoreUtilitiesTests()
run("testAppendWordsSplitsSpacesAndCommas", coreUtilities.testAppendWordsSplitsSpacesAndCommas)
run("testPathHelpers", coreUtilities.testPathHelpers)
run("testWinetricksVerbSupportRequiresEveryExactVerb", coreUtilities.testWinetricksVerbSupportRequiresEveryExactVerb)
run("testWinetricksCurrentVCRunChecksumsReplaceStaleValues", coreUtilities.testWinetricksCurrentVCRunChecksumsReplaceStaleValues)
run("testUSVFSDefaultSourceIsNotUserSpecific", coreUtilities.testUSVFSDefaultSourceIsNotUserSpecific)
run("testLaunchBatchEnvironmentIsOnlyAddedForModOrganizer", coreUtilities.testLaunchBatchEnvironmentIsOnlyAddedForModOrganizer)
run("testModOrganizerBatchUsesWindowsWorkingDirectory", coreUtilities.testModOrganizerBatchUsesWindowsWorkingDirectory)
run("testDefaultModOrganizerBatchDetectionIsNarrow", coreUtilities.testDefaultModOrganizerBatchDetectionIsNarrow)
run("testContainsLineBreakDetectsBothNewlineForms", coreUtilities.testContainsLineBreakDetectsBothNewlineForms)
run("testRegistryKeyValueEditorUpdatesSection", coreUtilities.testRegistryKeyValueEditorUpdatesSection)
run("testRegistryRawLineEditorUpdatesSection", coreUtilities.testRegistryRawLineEditorUpdatesSection)
run("testRegistryKeyValueEditorCreatesMissingSection", coreUtilities.testRegistryKeyValueEditorCreatesMissingSection)
